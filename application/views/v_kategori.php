...
<table id="tmbh" class="table table-hover table-stripped">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="#edit" onclick="edit('<?=$kat->id_kategori?>')" data-toggle="modal" class="btn btn-success">
					Ubah
				</a>
...
<div class="modal fade" id="tambah">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="color:grey; text-align: center;"><h2>Tambah Kategori</h2>
